...
<script type="text/javascript" src="../../js/jquery-1.10.2.min.js"></script>
 ...
 <%
	...
	//글번호를 매개변수로 전달하여 글번호에 해당되는 글의 정보를 검색
	...
	String DBPrice = buyBean.getPrice();
		...
		<article>
			...
			<form action = "updatePro.jsp" method = "post" name="fr">
				<table id = "notice">
					...
					<tr>
						...
						<td>
							...
							<select name="status">
								<option <%if(DBStatus.equals("구매중")){%>selected<%} %>>구매중</option>
								<option <%if(DBStatus.equals("구매완료")){%>selected<%} %>>구매완료</option>
				...
				<div id = "write-btns">
					...
					<input type = "button" value = "글목록" class = "btn" onclick = "location.href='buy.jsp'">
				</div>
			</form>
			<div class="clear"></div>
		</article>
