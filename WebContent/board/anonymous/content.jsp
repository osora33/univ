...
<%
	...
	AnonymousBean anonymousBean = dao.getAnonymous(num);
...
<body>
	<div id="wrap">
		...
		<ul>
			...
			<li id="upper1" class="upper"><a href="../../board/freeboard/freeboard.jsp">게시판</a>
				<ul id="lower1" class="lower">
					...
					<li><a href="../../board/anonymous/anonymous.jsp" class="now">익명게시판</a></li>
				</ul>
			</li>
		...
		<article>
			...
			%>
				<input type="button" value="글목록" class="btn" onclick = "location.href='anonymous.jsp?pageNum=<%=pageNum %>'">
			</div>
			<div class="clear"></div>
		</article>
		<script>
